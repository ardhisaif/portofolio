...
export const DATA = {
  name: "Ahmad Saifudin Ardhiansyah",
  initials: "DV",
...
I'm also expanding my knowledge by studying for a Bachelor's degree in Information Systems at Open University.`,
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/ardhisaif",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ardhisaif/",
        icon: Icons.linkedin,
  ...
  work: [
    {
      company: "Halobelanja",
      href: "https://halobelanja.com/e",
      badges: [],
      location: "Denpasar Bali",
      title: "Backend Developer",
      logoUrl: "/halobelanja.jpeg",
      start: "June 2023",
      end: "Present",
      description:
    ...
    },
    {
      company: "Kodingworks",
      badges: [],
      href: "https://www.linkedin.com/company/kodingworks/posts/?feedView=all",
      location: "Remote",
      title: "Software Engineer Intern",
      logoUrl: "/kodingworks.png",
      start: "October 2021",
      end: "June 2022",
      description:
  ...
  education: [
    ...
    },
    {
      ...
      degree: "Bootcamp Fullstack Golang Web Development",
      logoUrl: "/Fazztrack.png",
      start: "2022",
      end: "2023",
    },
  ],
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "FastAttend is a web-based attendance system for islamic study sessions (pengajian). It allows admins to record attendance manually or via QR code scanning.",
      technologies: [
        "Laravel",
        "PHP",
        "MySQL",
